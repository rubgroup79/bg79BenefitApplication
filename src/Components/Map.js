      ...
      <View style={{flex:2, flexDirection: 'column', justifyContent: "center"}}> 
        ...
        <Text style={{fontSize: 10}}>{(Math.floor(this.props.Distance * 10) / 10).toString() + ' KM away from you' }</Text>
         ...
         <Button
              ...
              onPress={()=>{this.sendSuggestion(this.props.UserCode)} }
              linearGradientProps={{
            ...
            <MapView.Callout 
              tooltip={false}>
               {/* style={{ flex: 1, position: 'absolute', width: 100, height: 80 }} */}
                <CallOutCard SenderCode={'2'} ReceiverCode={'1'} FirstName={'Dana'} LastName={'godo'} Distance={'45'} Age={'25'} Picture={"../../Images/TraineeAvatar.png"}></CallOutCard>
                    {/* <View style={{ flex: 1, flexDirection: 'column', justifyContent: "center", alignItems: "center" }}>
